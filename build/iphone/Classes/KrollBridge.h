...
@interface StartStopObject : KrollCoverageObject {
#else
@interface StartStopObject : KrollObject {
#endif
@private
...
extern NSString * StartStop$ModuleRequireFormat;
