 ...
 * Copyright (c) 2009-2011 by StartStop, Inc. All Rights Reserved.
...
@interface StartStopObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[StartStopObject class]])
		{
			for (NSString *key in [[(StartStopObject*)o modules] allKeys])
			{
