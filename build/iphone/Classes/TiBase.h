...
// in simulator we redefine to format for StartStop Developer console
...
{\
	NSString * exceptionName = [@"org.startstop." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.startstop";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIStartStopNativeItemNone = -1, 
	UIStartStopNativeItemSpinner = -2,
	UIStartStopNativeItemProgressBar = -3,
	
	UIStartStopNativeItemSlider = -4,
	UIStartStopNativeItemSwitch = -5,
	UIStartStopNativeItemMultiButton = -6,
	UIStartStopNativeItemSegmented = -7,
	
	UIStartStopNativeItemTextView = -8,
	UIStartStopNativeItemTextField = -9,
	UIStartStopNativeItemSearchBar = -10,
	
	UIStartStopNativeItemPicker = -11,
	UIStartStopNativeItemDatePicker = -12,
	
	UIStartStopNativeItemInfoLight = -13,
	UIStartStopNativeItemInfoDark = -14,
	
	UIStartStopNativeItemDisclosure = -15,
	
	UIStartStopNativeItemContactAdd = -16
};
